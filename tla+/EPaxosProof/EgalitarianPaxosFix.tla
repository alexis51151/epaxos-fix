...
VotedForIn(D,i,p,b) == 
    \* Fast Path
    \/ \E cleader \in Replicas : \E FQ \in FastQuorums(cleader) : 
        /\ p \in FQ
        /\ \A r \in FQ : PreAccept(D,i,r,b)
    \* Slow Path
    \/ Accept(D,i,p,b)

WontVoteIn(i,p,b) == logs[p].ballot > b /\ \A D \in SUBSET Instances : ~ VotedForIn(D,i,p,b)
...
SafeAt(D,i,b) == \A b2 \in 0 .. (b-1) :
                    \E cleader \in Replicas : \E Q \in Quorums(cleader) : 
                        \A p \in Q : VotedForIn(D,i,p,b) \/ WontVoteIn(i,p,b)
...
\* Last modified Mon Feb 01 18:18:24 CET 2021 by alexis51151
