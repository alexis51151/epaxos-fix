...
MsgInvAccept(m) ==  /\ \E cleader \in Replicas : \E Q \in Quorums(cleader) : m.src \in Q 
                    /\ VotedForIn(m.deps, m.inst, m.src, m.ballot) \* Accept means voting

MsgInvAcceptReply(m) == /\ \E cleader \in Replicas : \E Q \in Quorums(cleader) : m.src \in Q 
                        /\ \E m2 \in msgs : m2.type = "accept" /\ m2.bal = m.bal /\ m2.inst = m.inst \* There was an accept received to trigger Accept-Reply
